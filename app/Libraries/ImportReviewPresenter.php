...
class ImportReviewPresenter
{
    ...
    private const GROUPS = [
        'FILE'       => ['label' => 'File cannot be imported', 'hint' => 'The file could not be read. Fix it in Excel and upload again.'],
        ...
        'QR-01'      => ['label' => 'Missing QR',                 'hint' => 'Every person needs their family QR number.'],
        'QR-FORMAT'  => ['label' => 'Invalid QR',                 'hint' => 'Must be a whole number - no letters, decimals, or commas.'],
        'QR-05'      => ['label' => 'QR is zero',                 'hint' => 'The QR number must be greater than zero.'],
        'QR-07'      => ['label' => 'QR is too large',            'hint' => 'Above the allowed maximum.'],
        'QR-08'      => ['label' => 'QR cell contains an Excel error', 'hint' => 'The cell holds an Excel error value. Retype the number.'],
        'QR-12'      => ['label' => 'QR cell is a formula',       'hint' => 'Type the number itself, not a formula.'],
        ...
        'HEAD-NONE'  => ['label' => 'No Head in Family',          'hint' => 'Set Relationship = Head on exactly one person.'],
